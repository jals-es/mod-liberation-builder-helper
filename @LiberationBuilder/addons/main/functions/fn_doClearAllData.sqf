/*
 * Function: LBH_fnc_doClearAllData
 * Description: Actually clear all saved data (called after confirmation)
 *
 * Arguments: None
 *
 * Return Value: None
...
["All data cleared!", 0, 3] call LBH_fnc_showNotification;
diag_log "[LBH] All data cleared by user";
